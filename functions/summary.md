# Functions Summary (2026-05-03T23:41:54+0800)
...
- WAIVED: 1
- Result: PASS
- Run All Log: /home/wangshouxin/native-rdma-web/functions/logs/run_all_20260503_234152.log
...
| storage | FN-4 | 可配置压缩与去重 | PASS | 部分完成 | `/home/wangshouxin/native-rdma-web/functions/storage/FN-4/summary.md` |
...
| rdma | FN-4 | CPU 与 GPU 高速直通访问 | WAIVED | 硬件/环境豁免 | `/home/wangshouxin/native-rdma-web/functions/rdma/FN-4/summary.md` |
