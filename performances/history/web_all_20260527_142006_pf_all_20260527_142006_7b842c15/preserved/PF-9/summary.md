...
- Generated At: 2026-05-26T23:40:08+0800
- Key Result: overhead=0.0%, savings=11.47%, scale=33.3%
...
| `scale_gain_pct` | 33.3 |
| `threads_multi` | 8 |
| `malloc_ops_1t` | 15311109 |
| `slab_ops_1t` | 45727529 |
| `malloc_ops_Nt` | 14447090 |
| `slab_ops_Nt` | 19257380 |
| `malloc_live_rss_kb` | 303492 |
| `slab_live_rss_kb` | 268684 |
| `live_objects` | 262144 |
