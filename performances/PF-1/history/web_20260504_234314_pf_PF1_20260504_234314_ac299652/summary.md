...
- Generated At: 2026-05-04T00:40:38+0800
- Threshold (A): 1KB 对象吞吐量 >= 1,000,000 ops/s
- Threshold (B): 大对象带宽利用率 >= 50%（按 RDMA 网络发送带宽计算）
- Result: PASS
- Result Dir: /home/wangshouxin/native-rdma-web/performances/PF-1
- Raw JSON: /home/wangshouxin/native-rdma-web/performances/PF-1/raw.json
- Run Log: /home/wangshouxin/native-rdma-web/performances/PF-1/logs/run.log
...
- Network Bandwidth Utilization: 56.34% / threshold 50.0%
- Network TX Bandwidth: avg=56.341 Gbps, peak=59.14 Gbps
- Success Rate: 100.0%
...
| `bw_threads` | 3 |
| `bw_val_size` | 1048576 |
| `bw_network_tx_gbps_avg` | 56.341 |
| `bw_network_tx_gbps_peak` | 59.14 |
| `bw_link_gbps` | 100.0 |
| `bw_util_pct` | 56.34 |
| `bw_fail` | 0 |
| `bw_degraded` | 0 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 2 | 40.79% | 40.792 | 74.952 | 40.044 | 100.000% | 0 | 0.0% | FAIL |
| 3 | 56.34% | 56.341 | 59.14 | 56.821 | 100.000% | 0 | 0.0% | PASS |
| 4 | 68.05% | 68.051 | 77.637 | 68.407 | 92.004% | 10631 | 7.996% | FAIL |
