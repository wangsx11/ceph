...
- Generated At: 2026-05-27T01:02:18+0800
...
- Network Bandwidth Utilization: 59.21% / threshold 50.0%
- Network TX Bandwidth: avg=59.206 Gbps, peak=66.312 Gbps
- Success Rate: 100.0%
...
| `bw_threads` | 4 |
| `bw_val_size` | 1048576 |
| `bw_network_tx_gbps_avg` | 59.206 |
| `bw_network_tx_gbps_peak` | 66.312 |
| `bw_link_gbps` | 100.0 |
| `bw_util_pct` | 59.21 |
| `bw_fail` | 0 |
| `bw_degraded` | 0 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 2 | 32.48% | 32.48 | 58.217 | 31.912 | 100.000% | 0 | 0.0% | FAIL |
| 3 | 45.08% | 45.084 | 50.248 | 45.32 | 100.000% | 0 | 0.0% | FAIL |
| 4 | 59.21% | 59.206 | 66.312 | 59.514 | 100.000% | 0 | 0.0% | PASS |
