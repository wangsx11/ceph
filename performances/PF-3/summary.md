...
- Generated At: 2026-05-04T01:35:05+0800
- Key Result: hi=182851.0 ops/s, lo=134705.0 ops/s, gain=35.74%
...
- 高优先级吞吐：182851.0 ops/s。
- 低优先级吞吐：134705.0 ops/s。
- 高优先级吞吐是低优先级的 1.36x，相对低优先级提升 35.74%。
- 验收要求：提升比例 >= 22.0%；本次超过阈值 13.74 个百分点。
- 判定：PASS。
